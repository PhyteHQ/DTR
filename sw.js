...
const CACHE_NAME=`${CACHE_PREFIX}2026-09-02-pwa-7`;
const APP_SHELL=[
  './','./index.html','./styles.css','./enhancements.css','./dtr-quality.css','./dtr-uplink.css','./app.js','./enhancements.js','./dtr-pwa-install.js','./dtr-quality.js','./dtr-uplink.js','./dtr-pwa-updates.js','./manifest.webmanifest',
